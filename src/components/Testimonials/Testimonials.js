    ...
    <div className="testimonials_container" id="testimonials">
      ...
      <div className="testimonials_elements">
        <div className="testimonial_element">
          <img src="https://www.pikpng.com/pngl/m/292-2924795_user-icon-png-transparent-white-user-icon-png.png" alt="Testimonial 1" className="testimonial_element_img"></img>
